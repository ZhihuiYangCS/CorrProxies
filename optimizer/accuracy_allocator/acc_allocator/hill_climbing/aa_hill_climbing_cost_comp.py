...
from optimizer.accuracy_allocator.acc_allocator.accuracy_allocator_cost_comp_base import AccuracyAllocatorCostCompBase
from optimizer.accuracy_allocator.acc_allocator.accuracy_allocator_utility import AccCombPPFiltersList, \
    AccCombPPFiltersMap
from records.record import Record


class AccuracyAllocatorHillClimbingCC(AccuracyAllocatorCostCompBase):
    """
