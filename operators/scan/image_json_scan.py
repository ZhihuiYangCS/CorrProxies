...
from paths import IMAGE_COCO_TRAIN_DATA_PATH
from records.record import Record


class ImageJsonScan(JsonScan):
    """
    An interface to scan all image json data
    """
    ...
    def get_new_object(self, previous_operators=None, operator_name: str = ""):
        ...
        """
        return ImageJsonScan(read_path=self._read_path, file_mode=self.file_mode)
